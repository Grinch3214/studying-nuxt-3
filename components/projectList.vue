<template>
  ...
  <section v-else>
    <p class="text-right mb-2 text-blue-900 font-mono">
      Repos: {{ data.length }}
    </p>
    <ul class="grid grid-cols-1 gap-4">
      <li
        ...
        :key="repository.id"
        class="border border-gray-400 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white font-mono overflow-hidden rounded-md"
      >
